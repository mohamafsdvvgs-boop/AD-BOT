...
DEFAULT_CONFIG = {
    "host_usernames": ["27.870"],
    "admin_usernames": ["27.870"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "673990da346ffe3c060b38ac")
    api_token = os.getenv("API_TOKEN", "405538e0682004be4257f4488c1b6c90689141d1d649ade2ddadd66909a3c9af")
